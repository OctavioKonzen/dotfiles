// Arquivo: ags/widget/settings/layout.ts
/* eslint-disable max-len */
import Row from "./Row"
import Group from "./Group"
import Page from "./Page"
import WallpaperCurrent from "./Wallpaper" // Renomeado para clareza, se "Wallpaper" for o nome do seu componente de Row
import WallpaperPageContent from "./WallpaperPage" // <-- 1. Importar o conteúdo da nova página de wallpapers
import options from "options"
import icons from "lib/icons"
import Widget from "resource:///com/github/Aylur/ags/widget.js" // Necessário para o 'as any' ou se Group for flexível
...
// Definindo um ícone para wallpaper.
// Se você não tiver 'icons.ui.image', pode usar 'icons.ui.themes' ou adicionar um novo.
const wallpaperPageIcon = icons.ui.image || icons.ui.themes;

export default [
    Page("Theme", icons.ui.themes,
        Group("",
            // Este é o Row que permite definir UM wallpaper, que já estava na sua aba Theme
            WallpaperCurrent() as ReturnType<typeof Row>,
    ...
    // 2. Adicionar a nova página de Wallpapers
    Page("Wallpapers", wallpaperPageIcon, // Usando o ícone definido
        // A função Group espera um array de Rows.
        // WallpaperPageContent() retorna um Widget.Box.
        // Um Row também é um Widget.Box, mas com estrutura e props específicas (como 'opt').
        // O Group simplesmente adiciona os widgets fornecidos como filhos a um Box vertical.
        // Portanto, passar diretamente o resultado de WallpaperPageContent() (que é um Box) deve funcionar.
        Group("", WallpaperPageContent() as ReturnType<typeof Widget.Box>), // Título do grupo vazio, conteúdo é a página
    ),
] as const
